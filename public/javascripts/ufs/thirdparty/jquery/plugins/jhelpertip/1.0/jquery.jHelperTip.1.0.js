...
(function($) {
        $.fn.jHelperTip = function(options) {
                ...
                var getData = function(obj,e){
                        if (opts.source == "ajax") {
                                getPosition(e);
                                $(opts.ttC).html('<div>'+opts.loadingText+'</div>').show();


                                // sgl:sgaviria@gmail.com
				if (opts.urlAttr && opts.urlAttr != "") {
				   opts.url=$(obj).attr(opts.urlAttr);
				}
                                // end sgl
        ...
        $.fn.jHelperTip.defaults = {
                ...
                opacity:  1.0,
                loadingImg: "/images/front/ajax-loader-kit.gif",
                loadingText: "",
